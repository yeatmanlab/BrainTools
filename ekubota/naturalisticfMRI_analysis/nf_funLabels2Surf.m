    ...
    for l = 3:length(labels)
        for s=1:length(subs)
            cmd = ['cd /mnt/disks/scratch/freesurferRecon;'...
                ...
                '--srclabel fsaverage/label/MPM_',hems{h},'_',labels{l},'.label \'...
                '--trgsubject ',subs{s},' \' ...
                '--trglabel ',subs{s},'/label/MPM_',hems{h},'_',labels{l},'.label \' ...
                '--hemi ',hems{h}, ' \' ...
                '--regmethod surface']
    ...
    for l=1:length(labels)
        for s = 1:length(subs)
            cmd = ['cd ', '/mnt/disks/scratch/freesurferRecon/',subs{s},';'...
                'mri_label2vol \'...
                '--label /mnt/disks/scratch/freesurferRecon/',subs{s},'/label/MPM_',hems{h},'_',labels{l},'.label \'...
