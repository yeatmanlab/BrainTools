...
basedir = '/home/jyeatman/git/wmdevo/megtools/stim/readingD/'
#imagedirs = ['faces_localizer', 'limb_localizer', 'objects_localizer', 'place_localizer']
imagedirs = ['stim001', 'stim003', 'stim006', 'stim009', 'stim010', 'stim013', 'stim015', 'stim018']
nimages = 50  # number of images for each category
...
with ExperimentController('ShowImages', full_screen=True) as ec:
    ...
    for trial in imorder_shuf:
        ...
        last_flip = ec.flip(last_flip+imduration-adj)
