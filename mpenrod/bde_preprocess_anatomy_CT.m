...
%         mrAnatAverageAcpcNifti({fullfile(anatdir,subject,'t1_acpc_avg.nii.gz'), T1path}, fullfile(anatdir, subject, strcat('t1_acpc_',num2str(session),'.nii.gz')), ...
%             0, voxres(1:3),[],[],0);
%         close all
%
%     end
