function LB_preprocessfMRI(datadir,t1FileName)
...
% datadir = '/home/jyeatman/projects/Lindamood_Bell/MRI/child/intervention/session1/LB18_20130805/20130805_1025'
% t1FileName ='/home/jyeatman/projects/Lindamood_Bell/MRI/anatomy/LB18/t1.nii.gz'
%%%%%%%%%%%%%%%%%%%%%%%%%%%%% EDIT THIS:
...
if isempty(epifilenames)
    epifilenames = matchfiles([datadir '/localizer*.nii*'], 'tr');
end
...
%alignvolumedata_auto( mn, sd,0,[2 2 2],[],[],[],useMI);  % rigid body, fine, mutual information metric
...
%% Simulate an inplane from the T1 volume
