...
datadir = '/home/winawer/projects/saccadeMislocalization/RK20130317_SaccadeMislocalization/RAW';

% where should i save figures to?
figuredir = '/home/winawer/projects/saccadeMislocalization/RK20130317_SaccadeMislocalization/preprocess';
...
fieldmapfiles    = matchfiles([datadir  '/*fieldmap/*.nii*'],'tr');
B0inds           = ~cellfun(@isempty, (regexp(fieldmapfiles, 'B0')));
fieldmapB0files  = fieldmapfiles(B0inds);
fieldmapMAGfiles = fieldmapfiles(~B0inds);
...
inplanefilenames = matchfiles([datadir '/*Inplane*/*.nii*']);
...
epifieldmapasst = [1 1  2 2  3 3  4 4];  
...
mcmask =  { [0.5 0.36 0.48] [0.3 0.28 1];};
