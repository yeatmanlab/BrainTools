...
subs = ['102_rs','110_hh','145_ac','150_mg','151_rd','152_tc','160_ek','161_ak','162_ef',
    '163_lf','164_sf','170_gm','172_th','174_hs','179_gm','180_zd','207_ah','210_sb','211_lb',
    '201_gs','202_dd','203_am','204_am']
...
badsubs = ['102_rs150716','110_hh150824','152_tc160510','152_tc160527',
           '201_gs150818','201_gs150824','201_gs150908','162_ef160829',
           '203_am150922','203_am151009','202_dd150827','202_dd151013',
           '204_am151020',# These are not included
#           '102_rs160618','102_rs160815','110_hh160608','110_hh160809',
#           '145_ac160621','145_ac160823','150_mg160606','150_mg160825',
#           '151_rd160620','152_tc160422','152_tc160623','160_ek160627','160_ek160915',
#           '161_ak160627','161_ak160916',
#           '163_lf160707','163_lf160920','164_sf160707','164_sf160920',
#           '170_gm160613','170_gm160822',
...
#           '202_dd150919','202_dd151013','202_dd151103','203_am150831',
...
#    print("\n\n".join(params.subjects))
    ...
    if n == 2: # 201_gs150729
        params.run_names = ['%s_1', '%s_3', '%s_4','%s_5','%s_6'] #'%s_2', 
    else:
        params.run_names = ['%s_1', '%s_2', '%s_3', '%s_4','%s_5','%s_6'] #'%s_2', 
    ...
    params.reject = dict(grad=6000e-13, mag=9.0e-12)
        
    params.ssp_eog_reject = dict(grad=5000e-13, mag=6.0e-12, eog=np.inf)
    params.ssp_ecg_reject = dict(grad=5000e-13, mag=6.0e-12, ecg=np.inf)
        
    params.flat = dict(grad=1e-13, mag=1e-15)
    
    if n == 0: # 174_hs160829
        params.auto_bad_reject = dict(grad=10000e-13, mag=14.0e-12) # This should be high...
        params.tsss_dur = 8.
    else:
