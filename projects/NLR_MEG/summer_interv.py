...
#    print("\n\n".join(params.subjects))
    ...
    if n == 17 or 18: # 164_sf160707 or 164_sf160920
    ...
    if n == 24: # 174_hs160829
        params.auto_bad_reject = dict(grad=10000e-13, mag=13.0e-12) # This should be high...
        params.tsss_dur = 8.
    elif n == 16: # 163_lf160920
        params.auto_bad_reject = dict(grad=9000e-13, mag=11.0e-12)
        params.tsss_dur = 8.
    else:
