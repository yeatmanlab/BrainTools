...
plt.figure()
plt.clf()
plt.plot(times, M[:,task1],'-',color=c_table[3])
plt.fill_between(times, M[:,task1]-errM[:,task1], M[:,task1]+errM[:,task1], facecolor=c_table[3], alpha=0.2, edgecolor='none')
plt.plot(times, M[:,task2],'-',color=c_table[5])
plt.fill_between(times, M[:,task2]-errM[:,task2], M[:,task2]+errM[:,task2], facecolor=c_table[5], alpha=0.2, edgecolor='none')
plotsig2(times,nReps,X, task2, task1, all_subject, boot_pVal)

plt.figure()
plt.clf() 
plt.plot(times, M1[:,task1],'--',color=c_table[3],label='Low noise')
plt.fill_between(times, M1[:,task1]-errM1[:,task1], M1[:,task1]+errM1[:,task1], facecolor=c_table[3], alpha=0.2, edgecolor='none')
...
plotsig2(times,nReps,X, task2, task1, good_readers, boot_pVal)
...
plt.plot(times, M2[:,task2],'-',color=c_table[5],label='Low noise')
plt.fill_between(times, M2[:,task2]-errM2[:,task2], M2[:,task2]+errM2[:,task2], facecolor=c_table[5], alpha=0.2, edgecolor='none')
plotsig2(times,nReps,X, task2, task1, poor_readers, boot_pVal)
...
task_effect = np.mean(MM[np.int(t_window1[0]):np.int(t_window1[1]),:,task2], axis = 0) - np.mean(MM[np.int(t_window1[0]):np.int(t_window1[1]),:,task1], axis = 0)
task_effect_err = np.std(task_effect) / np.sqrt(len(task_effect))
temp_read = orig_twre[all_subject]
del temp1
...
fit = np.polyfit(task_effect, temp_read, deg=1)
ax.plot(task_effect, fit[0] * task_effect + fit[1], color=[0,0,0])
...
ax.plot(task_effect, temp_read, 'o', markerfacecolor=[.5, .5, .5], markeredgecolor=[1,1,1], markersize=10)
...
#plt.ylim([-1,6])
#plt.xlim([50,130])
np.corrcoef(temp_read,task_effect)
r, p = stats.pearsonr(temp_read,task_effect)
print('Task effect (all): correlation = %.4f, p = %.4f' %(r, p))

temp2 = np.mean(MM[np.int(t_window1[0]):np.int(t_window1[1]),:,task2], axis = 0)
temp3 = np.mean(MM[np.int(t_window1[0]):np.int(t_window1[1]),:,task1], axis = 0)

plt.figure()
plt.clf()
ax = plt.subplot()
ax.plot(temp2, temp3, 'o', markerfacecolor=[.5, .5, .5], markeredgecolor=[1,1,1], markersize=10)
plt.axis('square')
plt.ylim([0, 6])
plt.xlim([0, 6])
...
t_window1 = np.multiply(np.divide(np.add([350,450],[100,100]),1000.), sRate)
t_window1 = [np.int(i) for i in t_window1]

t_window1_poor = np.multiply(np.divide(np.add([450,550],[100,100]),1000.), sRate)
t_window1_poor = [np.int(i) for i in t_window1]
...
temp2_poor = np.mean(MM[np.int(t_window1_poor[0]):np.int(t_window1_poor[1]),:,task2], axis = 0)
temp3_poor = np.mean(MM[np.int(t_window1_poor[0]):np.int(t_window1_poor[1]),:,task1], axis = 0)
del temp1

task_effect = np.concatenate((task_effect_good,task_effect_poor))
...
temp2 = np.concatenate((temp2,temp2_poor))
temp3 = np.concatenate((temp3,temp3_poor))
xxx = np.linspace(0,5,101)
yyy = xxx

plt.figure()
plt.clf()
ax = plt.subplot()
ax.plot(temp3_poor, temp2_poor, 'o', markerfacecolor=c_table[3], markeredgecolor=[1,1,1], markersize=10)
ax.plot(temp3_good, temp2_good, 'o', markerfacecolor=c_table[5], markeredgecolor=[1,1,1], markersize=10)
ax.plot(xxx,yyy,'-',color=[.5, .5, .5])
plt.axis('square')
plt.ylim([0, 6])
plt.xlim([0, 6])
###############################################################################
...
temp1 = X11[:,:,all_subject,:]
M1 = np.mean(temp1[temp_vertices,:,:,:],axis=0)
lowNoise_lexical = np.mean(M1[np.int(t_window1[0]):np.int(t_window1[1]),:,task], axis = 0)
lowNoise_lexical_err = np.std(lowNoise_lexical) / np.sqrt(len(lowNoise_lexical))

task = 0
lowNoise_dot = np.mean(M1[np.int(t_window1[0]):np.int(t_window1[1]),:,task], axis = 0)
lowNoise_dot_err = np.std(lowNoise_dot) / np.sqrt(len(lowNoise_dot))

plt.figure(100)
plt.clf()

plt.bar(1, np.mean(lowNoise_lexical), width=0.3, \
        yerr = lowNoise_lexical_err, color=c_table[5], ecolor = [0,0,0])

plt.bar(2, np.mean(lowNoise_dot), width=0.3, \
        yerr = lowNoise_dot_err, color=c_table[4], ecolor = [0,0,0])
plt.xticks([1,2],('Lexical','Fixation'))
plt.xlim([0,3])
plt.ylim([-0.1,2.0])
plt.ylabel('dSPM source estimate')
plt.title('300 ms ~ 600 ms')
...
plotit2(times, M, errM, 4, 3, yMin=0, yMax=2.3, subject = 'all')
plotsig2(times,nReps,X, 4, 3, all_subject, boot_pVal)
...
fit = np.polyfit(temp_meg1, p_temp_meg1, deg=1)
ax.plot(temp_meg1, fit[0] * temp_meg1 + fit[1], color=[0,0,0])
#fit = np.polyfit(dot_lowNoise1_good, orig_twre[good_readers], deg=1)
#ax.plot(dot_lowNoise1_good, fit[0] * dot_lowNoise1_good + fit[1], color=c_table[5])
ax.plot(temp_meg1, p_temp_meg1, 'o', markerfacecolor=[.5, .5, .5], markeredgecolor=[1,1,1], markersize=10)
#ax.plot(dot_lowNoise1_good, orig_twre[good_readers], 'o', markerfacecolor=c_table[5], markeredgecolor=[1,1,1], markersize=10)
...
#plt.ylim([-1,6])
#plt.xlim([50,130])
np.corrcoef(p_temp_meg1,temp_meg1)
r, p = stats.pearsonr(p_temp_meg1,temp_meg1)
print('pseudo_dot(all): correlation = %.4f, p = %.4f' %(r, p))
#np.corrcoef(orig_twre[good_readers],dot_lowNoise1_good)
#r, p = stats.pearsonr(orig_twre[good_readers],dot_lowNoise1_good)
#print('dot(good): correlation = %.4f, p = %.4f' %(r, p))
#np.corrcoef(orig_twre[poor_readers],dot_lowNoise1_poor)
...
#print('dot(poor): correlation = %.4f, p = %.4f' %(r, p))
os.chdir('figures')
plt.savefig('STG_corr_pseudo_dot.png',dpi=600,papertype='letter',format='png')
plt.savefig('STG_corr_pseudo_dot.pdf',dpi=600,papertype='letter',format='pdf')
os.chdir('..')
...
np.corrcoef(temp_read,temp_meg2)
r, p = stats.pearsonr(temp_read,temp_meg2)
print('pseudo_lexical(all): correlation = %.4f, p = %.4f' %(r, p))
#np.corrcoef(orig_twre[good_readers],lowNoise1_good)
#r, p = stats.pearsonr(orig_twre[good_readers],lowNoise1_good)
#print('lexical(good): correlation = %.4f, p = %.4f' %(r, p))
#np.corrcoef(orig_twre[poor_readers],lowNoise1_poor)
...
#print('lexical(poor): correlation = %.4f, p = %.4f' %(r, p))
os.chdir('figures')
plt.savefig('STG_corr_pseudo_lexical.png',dpi=600,papertype='letter',format='png')
plt.savefig('STG_corr_pseudo_lexical.pdf',dpi=600,papertype='letter',format='pdf')
os.chdir('..')
...
np.corrcoef(temp_meg1,temp_meg2)
r, p = stats.pearsonr(temp_meg1,temp_meg2)
print('pseudo_Dot_Lexical: correlation = %.4f, p = %.4f' %(r, p))
#np.corrcoef(orig_twre[good_readers],lowNoise1_good)
#r, p = stats.pearsonr(orig_twre[good_readers],lowNoise1_good)
#print('lexical(good): correlation = %.4f, p = %.4f' %(r, p))
#np.corrcoef(orig_twre[poor_readers],lowNoise1_poor)
...
#print('lexical(poor): correlation = %.4f, p = %.4f' %(r, p))
os.chdir('figures')
plt.savefig('STG_corr_pseudo_dot_lexical.png',dpi=600,papertype='letter',format='png')
plt.savefig('STG_corr_pseudo_dot_lexical.pdf',dpi=600,papertype='letter',format='pdf')
os.chdir('..')
